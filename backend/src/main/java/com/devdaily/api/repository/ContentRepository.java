...
public interface ContentRepository extends JpaRepository<Content, Long> {
    ...
    @Query("SELECT c FROM Content c WHERE c.active = true AND (c.type IN :types) AND (c.area IN :areas OR c.technology IN :techs)")
    ...
    @Query("SELECT c FROM Content c WHERE c.active = true AND (c.area IN :areas OR c.technology IN :techs)")
